...
private String username="";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 10, 270, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Drug ID", "name", "Drug manfucture", "stock", "price", "drug Type", "Manfucture Date", "expire Date"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(a==0){
          ...
          PreparedStatement ps=con.prepareStatement("delete from medicine where  drugID=?");
          ps.setString(1, id);
          ps.executeUpdate();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            while(rs.next()){
                 model.addRow(new Object[]{rs.getString("drug_ID"),rs.getString("Drug_Name"),rs.getString("Drug_Manifacurer"),rs.getString("stock"),rs.getString("price"),rs.getString("drug_Type"),rs.getString("Manifacture_Date"),rs.getString("Expire_Date")});
